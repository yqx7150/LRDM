...
def main( predict_config: OmegaConf):
    ...
    try:
        ...
        ori_input =scipy.io.loadmat("/home/b109/Desktop/XX/inpainting/data/mri/val_256/test_data/cut256头部t1-fse2_Image.mat")['centerImageData']
        #ori_input =scipy.io.loadmat("/home/b109/Desktop/XX/inpainting/data/mri/val_256/test_data/磁共振常用数据集/SIAT-Brain_test_12ch/8.mat")['Img']
        #ori_input =scipy.io.loadmat("/home/b109/Desktop/XX/inpainting/data/mri/val_256/val_source_256/1141.mat")['Img']
        ...
        #ori_input =scipy.io.loadmat("/home/b109/Desktop/XX/inpainting/data/mri/val_256/test_data/kspace_ori__1.mat")['kspace_ori_']  #20coil
        #ori_input =scipy.io.loadmat("/home/b109/Desktop/XX/inpainting/data/mri/val_256/test_data/modl/ori_complex.mat")['data']  #8coil
        #ori_input =scipy.io.loadmat("/home/b109/Desktop/XX/inpainting/data/mri/val_256/test_data/test-20ch.mat")['Img']  #8coil
        ...
        ww = io.loadmat('/home/b109/Desktop/XX/inpainting/data/mri/weight/weight_GE_brain_12.mat')['weight']  #11
        ...
        #ww = io.loadmat('/home/b109/Desktop/XX/inpainting/data/mri/weight/weight_GE_brain_07_05_210_2.mat')['weight']   #38.74
        ...
        weight_img = np.sqrt(np.sum(np.square(np.abs(weight)),axis=0))
        weight_img = weight_img/np.max(np.abs(weight_img)) 
        write_images(abs(weight_img),osp.join(save_path,'weight_img'+'.png'))
        ...
        #mask_item = io.loadmat('/home/b109/Desktop/XX/inpainting/data/mri/mask/poisson/4.mat')['mask']
        ...
        mask_item = io.loadmat('/home/b109/Desktop/XX/inpainting/data/mri/mask/random2D/5.mat')['mask']
        #mask_item = io.loadmat('/home/b109/Desktop/XX/inpainting/data/mri/mask/mask_cartR3.mat')['mask']
        #mask_item = io.loadmat('/home/b109/Desktop/XX/inpainting/data/mri/mask/cart_random/cart_256_acs0_准/cart_256_acs0_r10.mat')['mask']
        #mask_item = io.loadmat('/home/b109/Desktop/XX/inpainting/data/mri/mask/mask_item.mat')['mask']
        #mask_item = io.loadmat('/home/b109/Desktop/XX/inpainting/data/mri/mask/uniform_256_acs24_不准/Uniform1D_256_acs24_r14.mat')['mask']
        #mask_item = io.loadmat('/home/b109/Desktop/XX/inpainting/data/mri/mask/mask_cartR6.mat')['mask']
        #mask_item = io.loadmat('/home/b109/Desktop/XX/inpainting/data/mri/mask/mask_radial_020.mat')['mask_radial_020']  
        #mask_item = io.loadmat('/home/b109/Desktop/XX/inpainting/data/mri/mask/random_256_acs24_不准/random2D_256_acs24_r15.mat')['mask']
        #mask_item = io.loadmat('/home/b109/Desktop/XX/inpainting/data/mri/mask/mask_cartR6.mat')['mask']


        
        #mask_item0 = io.loadmat('/home/b109/Desktop/XX/inpainting/data/mri/val_256/test_data/modl/mask_random8.mat')['data']
        #mask_item0=np.fft.fftshift(mask_item0)
        #mask_item=mask_item0[0,:,:]
        ...
        k_w_m_sos = np.sqrt(np.sum(np.square(np.abs(k_w_m)),axis=0))
        k_w_m_sos = k_w_m_sos/np.max(np.abs(k_w_m_sos))
        write_images(abs(k_w_m_sos),osp.join(save_path,'k_w_m_sos'+'.png'))

        k_w_void_m_sos = np.sqrt(np.sum(np.square(np.abs(k_w_void_m)),axis=0))
        k_w_void_m_sos = k_w_void_m_sos/np.max(np.abs(k_w_void_m_sos))
        write_images(abs(k_w_void_m_sos),osp.join(save_path,'k_w_void_m_sos'+'.png'))
...
#------------------------------------计算后处理--------------------------------------------
        ...
        io.savemat(osp.join(save_path,'NCSNpp_Image.mat'),{'data':NCSNpp_Image})
        io.savemat(osp.join(save_path,'k_complex2_mutli_coil.mat'),{'data':k_complex2})
