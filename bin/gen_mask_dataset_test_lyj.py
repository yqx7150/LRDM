...
def process_images(src_images, indir, outdir, config):
    ...
    for infile in src_images:
        try:
            ...
            #加载权重
            weight = loadmat('/home/b109/code/xx/DiffIR-master/DiffIR-master/DiffIR-inpainting/data/mri4000/weight/weight1.mat')['weight']
            kdata_w = k2wgt(siat_kdata, weight)

            data={"k_w":kdata_w}
            savemat("/home/b109/code/xx/DiffIR-master/DiffIR-master/DiffIR-inpainting/data/temp/kw_test.mat" , data)
            ...
            mat=io.loadmat('/home/b109/code/xx/DiffIR-master/DiffIR-master/DiffIR-inpainting/data/mri4000/mask/poisson/6.mat')
            mask_item = mat['mask']
            # mask_item = np.fft.fftshift(mask_item)
            mask[0, :, :] = mask_item
            src_masks=mask
            ...
            for i, idx in enumerate(mask_indices):
                ...
                savemat("/home/b109/code/xx/DiffIR-master/DiffIR-master/DiffIR-inpainting/data/mri4000/val_256/random_thick_256_test/"+"_mask"+file_name, mask)
                # cur_image.save(cur_basename + '.mat')
                data={"k_w":cur_image}
                savemat("/home/b109/code/xx/DiffIR-master/DiffIR-master/DiffIR-inpainting/data/mri4000/val_256/random_thick_256_test/"+file_name, data)
