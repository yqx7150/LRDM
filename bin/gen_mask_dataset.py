...
def process_images(src_images, indir, outdir, config):
    ...
    for infile in src_images:
        try:
            ...
            # mat=io.loadmat('/home/b109/code/xx/DiffIR-master/DiffIR-master/DiffIR-inpainting/data/mri4000/mask/random/random_0.25.mat')
            # mask_item = mat['mask']
            # mask[0, :, :] = mask_item
            ...
            for i, idx in enumerate(mask_indices):
                ...
                savemat("/home/b109/code/xx/DiffIR-master/DiffIR-master/DiffIR-inpainting/data/mri4000/val_256/random_thick_256/"+"_mask"+file_name, mask)
                # cur_image.save(cur_basename + '.mat')
                data={"k_w":cur_image}
                savemat("/home/b109/code/xx/DiffIR-master/DiffIR-master/DiffIR-inpainting/data/mri4000/val_256/random_thick_256/"+file_name, data)
